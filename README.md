...
A terminal-based version of **Scoundrel**, built with Textual.

Scoundrel is a single player rogue-like card game for use with a standard deck of playing cards.
Each room presents four cards - draw, decide, survive.
Originally developed by Zach Gage and Kurt Bieg.
